...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpeakupPageExtension'
        db.create_table(u'fh_speakuppageextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['fh.SpeakupPageExtension'])),
            ('extended_object', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.Page'], unique=True)),
            ('header_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal(u'fh', ['SpeakupPageExtension'])


    def backwards(self, orm):
        # Deleting model 'SpeakupPageExtension'
        db.delete_table(u'fh_speakuppageextension')
    ...
    models = {
        ...
        u'fh.speakuppageextension': {
            'Meta': {'object_name': 'SpeakupPageExtension'},
            'extended_object': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.Page']", 'unique': 'True'}),
            'header_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'public_extension': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_extension'", 'unique': 'True', 'null': 'True', 'to': u"orm['fh.SpeakupPageExtension']"})
        },
        u'filer.file': {
